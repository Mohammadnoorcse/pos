...
export function MainLayout({ children, activePage, onNavigate }) {
  // null = main menu, otherwise a wing id like "supplier", "godowns", "acc", ...
  ...
  return (
    <div className="min-h-screen flex" style={{ backgroundColor: COLORS.paper }}>
      ...
      >
        <div className="flex items-center gap-2.5 px-1.5 pb-4 mb-3 border-b border-white/10">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
            ...
            />
            <path
              d="M12 19C12 19 9 21 9 22.2C9 22.6 9.4 23 12 23C14.6 23 15 22.6 15 22.2C15 21 12 19 12 19Z"
              fill={COLORS.peacock}
            />
          </svg>
          <span
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        />
        <div className="p-4 md:p-7 space-y-5 overflow-auto flex-1">
          {children}
        </div>
      </div>
    </div>
