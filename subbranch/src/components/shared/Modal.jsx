...
export function AddBranchModal({
  ...
  const [isMain, setIsMain] = React.useState(initialIsMain);
  const inputRef = React.useRef(null);
  ...
  const handleCreate = () => {
    ...
    onCreate(trimmedName, address.trim(), isMain);
    setName("");
    setAddress("");
    setIsMain(false);
  };
        ...
        <div className="p-6 pt-7">
          ...
          <div className="space-y-4 mb-5">
            ...
            <label className="flex items-center gap-2 cursor-pointer select-none">
              ...
              >
                এটাই Main / HQ branch — শুধু এই branch এর staff, Owner ও Admin
                main পোর্টাল থেকে login করতে পারবে। (একটাই branch main হতে পারে)
              </span>
            </label>
          </div>
