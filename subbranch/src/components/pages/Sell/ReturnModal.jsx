    ...
    try {
      ...
      for (const it of selected) {
        const res = await createSaleReturn({
          ...
          return_date: today,
          // 'direct' => money actually leaves cash/bank now, 'exchange' => just adjusts the invoice
          refund_action: refundAction,
          // only meaningful when refund_action === 'direct'
          account: refundAction === "direct" && refundMethod === "bank" ? bankMethod : "cash",
        });
        results.push(res);
      }
